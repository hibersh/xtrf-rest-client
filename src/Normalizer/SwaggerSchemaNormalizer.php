...
/**
 * @file
 * Contains \drunomics\XtrfClient\Normalizer\SwaggerSchemaNormalizer.
 */

namespace drunomics\XtrfClient\Normalizer;

use drunomics\XtrfClient\SwaggerSchema;
...
class SwaggerSchemaNormalizer extends ObjectNormalizer {
   ...
   * The swagger schema.
   *
   * @var \drunomics\XtrfClient\SwaggerSchema
   */
  protected $schema;
   ...
   * @param \drunomics\XtrfClient\SwaggerSchema $schema
